...
import com.g2software.querybuilder.transformer.AddResultFromArray;
import com.g2software.querybuilder.transformer.AddResultFromMap;
import com.g2software.querybuilder.transformer.QueryResultTransformer;
import com.g2software.querybuilder.transformer.ReturnResult;
...
public class HqlExecutor extends QueryExecutor {
	...
	public <K,V> Map<K,V> getResultMap() {
		if (this.getQueryBuilder()
			...
			query.setResultTransformer(new HB3ResultTransformerForArrays(new com.g2software.querybuilder.transformer.MapResultTransformer(1000)));
		}
		query.list();
